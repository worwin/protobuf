...
static int MaybeReleaseOverlappingOneofField(CMessage* cmessage,
                                             const FieldDescriptor* field) {
  Message* message = const_cast<Message*>(cmessage->message);
...
int MaybeReleaseOneofBeforeMerge(CMessage* self, const Message& other) {
  ...
  Message* message = const_cast<Message*>(self->message);
  const Reflection* reflection = message->GetReflection();
...
static int InternalReparentFields(
  ...
  if (self->message->GetArena() == new_message->message->GetArena()) {
    MessageReflectionFriend::UnsafeShallowSwapFields(
        const_cast<Message*>(self->message),
        const_cast<Message*>(new_message->message),
...
PyObject* ContainerBase::DeepCopy() {
  ...
  tmp->GetReflection()->SwapFields(tmp.get(),
                                   const_cast<Message*>(new_parent->message),
